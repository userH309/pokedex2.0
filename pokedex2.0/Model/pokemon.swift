...
class pokemon
{
    ...
    var name:String //create getter for the name
    {
        return _name
    }
    var pokedexID:Int
    {
        return _pokedexID //create getter for the ID
    }
    var type:String
    {
        if _type == nil
    ...
    init(name:String, pokedexID:Int) //create init with two parameters
    {
        self._name = name
                        ...
                        { (response) in
                            if let dict2 = response.value as? Dictionary<String, AnyObject>
                            {
                                ...
                                if let evolution_chain = dict2["evolution_chain"] as? Dictionary <String,String>
                                {
                                    ...
                                    {
                                        Alamofire.request(urlEvo).responseJSON
                                        { (response2) in
                                            print(urlEvo)
